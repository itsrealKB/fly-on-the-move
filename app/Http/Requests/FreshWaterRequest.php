...
class FreshWaterRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'video_thumbnail' => 'nullable|array|required_without:video_link',
            ...
            'video_file.*' => 'mimes:mp4,avi,mov,wmv,flv,webm,mpeg'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'video_thumbnail.required_without' => 'Please Upload Video Thumbnail Image',
