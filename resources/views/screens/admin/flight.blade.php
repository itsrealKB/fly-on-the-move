...
@section('content')
                                                    ...
                                                    <td class="order-view">
                                                        <div class="dropdown table-btn-drop">
                                                            ...
                                                            <ul class="dropdown-menu table-menu-drop">
                                                                ...
                                                                <li><a class="dropdown-item" onclick="flightup()" href="#"><i class="fa-regular fa-eye"></i> View Details</a></li>
    ...
    <div class="rechdule-pop-up-back">
        <div class="reschdule-popup">
            <div class="close-btn-reschdule" onclick="flightupClose()" >
...
@push('scripts')
    ...
    <script>
            const flightupWrap = document.querySelector('.rechdule-pop-up-back')
            function flightup() {
            flightupWrap.classList.add('active')
            }

            function flightupClose() {
            console.log("hello")
            flightupWrap.classList.remove('active')
            }
