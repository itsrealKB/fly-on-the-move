                            ...
                            <div class="payment-card-area">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="payment-select-radio">
                                            <div class="radio-box">
                                                ...
                                                <label for="feedback" class="radio-label"><i class="fa-solid fa-check"></i> Credit Card </label>
                                            </div>
                                            <div class="radio-box">
                                                <input type="radio" id="paypal" value="FeedBack" name="feedbackCategory">

                                                <label for="paypal" class="radio-label"> <i class="fa-solid fa-check"></i> PayPal </label>
                                            </div>
                                            <div class="radio-box">
                                                <input type="radio" id="bank-account" value="FeedBack" name="feedbackCategory">

                                                <label for="bank-account" class="radio-label"><i class="fa-solid fa-check"></i> Bank Account </label>
                                            </div>
                                        </div>
                                    </div>
                                    <!--cardArea-->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="container preload cardpaypal">
                                    ...
                                    <div class="main-parent-node">
                                        <div class="parentNode row ad-inps">
                                            <div class="col-12">
                                                <div class="payment-input-title">
                                                    <h2>Add Another Payment Method</h2>
                                                    <button class="close-credit-card"><i class="fa-solid fa-xmark"></i></button>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="profile-data-area">
                                                        ...
                                                        <div class="profile-detail">
                                                            ...
                                                            <div class="card-input-area">
                                                                ...
                                                                <input id="cardnumber" type="text" pattern="[0-9]*" inputmode="numeric" placeholder="123748 8797 87">
                                                        ...
                                                        <div class="profile-detail">
                                                            ...
                                                            <div class="card-input-area">
                                                                <input id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric" placeholder="1/26">
                                                            </div>
                                                        </div>
                                                        <div class="profile-detail">
                                                            ...
                                                            <div class="card-input-area">
                                                                <input id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric" placeholder="1234">
                                                            </div>
                                                        </div>
                                                        <div class="profile-detail">
                                                            <label for="">
                                                        ...
                                                        <div class="profile-detail border-radius-last-child">
                                                            ...
                                                            <div class="card-input-area">
                                                                <input type="text" name="card-number" class="cardnumber width" placeholder="00000" maxlength="5" oninput="validateCardNumber(this)">
                                                            </div>
                                                        </div>
                                                        <div class="add-button-pymt">
...
@push('scripts')
    ...
    <script>
        ...
        const mainParent = document.querySelector(".main-parent-node");
        const itemRow = document.querySelector(".ad-inps");
        const addBtn = document.querySelector(".addItem");
        const parent = document.querySelector(".parentNode");
        addBtn.addEventListener("click", () => {
            const clone = itemRow.cloneNode(true);
            mainParent.appendChild(clone);
            const updatedClosebtns = document.querySelectorAll(".close-credit-card");
            if (updatedClosebtns.length > 1) {
                updatedClosebtns.forEach(btn => {
        ...
        mainParent.addEventListener("click", (e) => {
            if (e.target.closest(".close-credit-card")) {
                e.target.closest(".ad-inps").remove()
            }
            const updatedClosebtns = document.querySelectorAll(".close-credit-card");
            if (updatedClosebtns.length === 1) {
                updatedClosebtns.forEach(btn => {
        ...
        $(document).ready(function() {
            $('input[name="feedbackCategory"]').change(function() {
