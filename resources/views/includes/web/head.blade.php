...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/web/images/fav.png') }}" type="image/x-icon" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/web/css/home-page-responsive.css') }}" />
    <link
...
/>
    ...
    <title>@yield('title', 'Fly ON The Move') </title>
